...
class FavouritesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create favourite" do
    assert_difference('Favourite.count') do
      post favourites_url, params: { favourite: { show_id: @favourite.show_id, user_id: @favourite.user_id } }
    end
  ...
  test "should update favourite" do
    patch favourite_url(@favourite), params: { favourite: { show_id: @favourite.show_id, user_id: @favourite.user_id } }
